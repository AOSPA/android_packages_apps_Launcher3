...
public class AssistUtils implements SettingsCache.OnChangeListener, SafeCloseable {
    ...
    private final ContextualSearchManager mContextualSearchManager;
    private final String mContextualSearchPkg;
    private final int mContextualSearchDefValue;
    private final Intent mCtsPkgIntent;
