...
class IconPacksRecyclerViewAdapter extends RecyclerView.Adapter<IconPacksRecyclerViewAdapter.SimpleViewHolder> {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //inflate recycler view item layout
    ...
    public void onBindViewHolder(SimpleViewHolder holder, int position) {
        ...
        Drawable icon = mLauncher.getResources().getDrawable(R.drawable.ic_google_play, mLauncher.getTheme());
