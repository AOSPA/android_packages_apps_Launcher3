...
class RevealEditView {
    ...
    static void close(final Launcher launcher, final boolean noIconPacks, final boolean isIconPackChooser, final String iconPack) {
        ...
        anim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (noIconPacks) {
                    Intent goToMarket = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("market://search?q=" + launcher.getString(R.string.icons_pack_name)));
