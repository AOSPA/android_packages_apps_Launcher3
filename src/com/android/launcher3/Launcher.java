...
public class Launcher extends Activity
    ...
    private void updateColor(boolean enabled) {
        ...
        final int mPrimaryColor = context.getColor(
                com.android.internal.R.color.dark_primary_color);
        final int mOriginalColor = context.getColor(R.color.all_apps_container_color);
        final int mTextColor = context.getColor(
                com.android.internal.R.color.white_accent_color);
    ...
    private int selectColor() {
        ...
        int mColor = R.style.LauncherTheme; // Default
        if (!mThemeEnabled) {
            return mColor;
        }
        switch (color) {
            case 1:
                mColor = R.style.dark_launcher_red;
                break;
            case 2:
                mColor = R.style.dark_launcher_teal;
                break;
            case 3:
                mColor = R.style.dark_launcher_orange;
                break;
            case 4:
                mColor = R.style.dark_launcher_white;
                break;
            case 5:
                mColor = R.style.dark_launcher_green;
                break;
            case 6:
                mColor = R.style.dark_launcher_yellow;
                break;
            case 7:
                mColor = R.style.dark_launcher_purple;
                break;
            case 0:
            default:
                mColor = R.style.dark_launcher;
                break;
        }
        return mColor;
    }
