...
import co.aospa.launcher.ParanoidQuickstepLauncher;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        ParanoidQuickstepLauncher launcher = (ParanoidQuickstepLauncher) ActivityContext.lookupContext(context);
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        ParanoidQuickstepLauncher launcher = (ParanoidQuickstepLauncher) ActivityContext.lookupContext(getContext());
